...
/**
  ...
  */
case class SimpleFold2(problemString: String)(xOffset: Int = 0, yOffset: Int = 0) {
...
object simpleFoldExample2 extends App {
  val problem = Problems.prob8

  private val solving: String = problem.stripMargin('|')

  GraphicProblemViewer(solving)
  val sF = SimpleFold2(solving)(0, 0)
